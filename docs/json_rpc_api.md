...
* Unlike bitcoind that has the wallet and chain intermingled in the same process
  ...
  [btcwallet](https://github.com/zeusyf/btcwallet).
...
such as [btcwallet](https://github.com/zeusyf/btcwallet) for inter-process
...
[btcrpcclient](https://github.com/zeusyf/btcrpcclient) package.
...
[btcrpcclient](https://github.com/zeusyf/btcrpcclient) package to connect with
...
import (
	"github.com/zeusyf/btcrpcclient"
