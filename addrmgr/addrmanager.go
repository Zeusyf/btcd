...
func (a *AddrManager) DeserializeNetAddress(addr string) (*wire.NetAddress, error) {
	...
	return a.HostToNetAddress(host, uint16(port), common.SFNodeNetwork)
}
...
func (a *AddrManager) HostToNetAddress(host string, port uint16, services common.ServiceFlag) (*wire.NetAddress, error) {
...
func (a *AddrManager) SetServices(addr *wire.NetAddress, services common.ServiceFlag) {
	a.mtx.Lock()
	defer a.mtx.Unlock()
