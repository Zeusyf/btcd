...
func txRuleError(c common.RejectCode, desc string) RuleError {
	return RuleError{
...
func extractRejectCode(err error) (common.RejectCode, bool) {
	...
	case blockchain.RuleError:
		...
		var code common.RejectCode
		switch err.ErrorCode {
		// Rejected due to duplicate.
		case blockchain.ErrDuplicateBlock:
			code = common.RejectDuplicate

		// Rejected due to obsolete version.
		case blockchain.ErrBlockVersionTooOld:
			code = common.RejectObsolete
		...
		case blockchain.ErrForkTooOld:
			code = common.RejectCheckpoint

		// Everything else is due to the block or transaction being invalid.
		default:
			code = common.RejectInvalid
		}
	...
	case nil:
		return common.RejectInvalid, false
	}
...
func ErrToRejectErr(err error) (common.RejectCode, string) {
	...
	// err to panic.
	if err == nil {
		return common.RejectInvalid, "rejected"
	}
	...
	// text.
	return common.RejectInvalid, "rejected: " + err.Error()
}
