...
func (msg *MsgMerkleBlock) OmcDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	...
	msg.Flags, err = common.ReadVarBytes(r, pver, maxFlagsPerMerkleBlock,
...
func (msg *MsgMerkleBlock) OmcEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	...
	err = common.WriteVarInt(w, pver, uint64(numHashes))
	if err != nil {
		return err
	}
	...
	return common.WriteVarBytes(w, pver, msg.Flags)
}
