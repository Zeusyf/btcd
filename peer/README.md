...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/zeusyf/btcd/peer)
...
```bash
$ go get -u github.com/zeusyf/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/zeusyf/btcd/peer#example-package--NewOutboundPeer)  
